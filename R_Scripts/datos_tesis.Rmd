...
Se tomaron las estaciones comunes para cada data set y conformar el año: TLA MER SAG
```{r, eval=F, echo=T}
...
# # quedaron 5 estaciones en común
# 
# redma11_A_tidy <- redma11_A[ ,estaciones_comunes] %>% gather(estaciones, valor, MER:XAL, -FECHA) %>% mutate(pollutant = "?")
