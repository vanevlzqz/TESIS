...
rama10_b_tidy <- rama10_b[ ,estaciones_comunes_rama10] %>% gather(estaciones, valor, TLA:SAG, -FECHA) %>% mutate(pollutant = "NO")
rama10_c_tidy <- rama10_c[ ,estaciones_comunes_rama10] %>% gather(estaciones, valor, TLA:SAG, -FECHA) %>% mutate(pollutant = "NOX")
rama10_d_tidy <- rama10_d[ ,estaciones_comunes_rama10] %>% gather(estaciones, valor, TLA:SAG, -FECHA) %>% mutate(pollutant = "O3")
rama10_e_tidy <- rama10_e[ ,estaciones_comunes_rama10] %>% gather(estaciones, valor, TLA:SAG, -FECHA) %>% mutate(pollutant = "PM10")
rama10_f_tidy <- rama10_f[ ,estaciones_comunes_rama10] %>% gather(estaciones, valor, TLA:SAG, -FECHA) %>% mutate(pollutant = "PM25")
rama10_g_tidy <- rama10_g[ ,estaciones_comunes_rama10] %>% gather(estaciones, valor, TLA:SAG, -FECHA) %>% mutate(pollutant = "SO2")
